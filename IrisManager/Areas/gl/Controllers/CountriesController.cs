...
namespace IrisManager.Areas.gl.Controllers
{
    public class CountriesController : Controller
    {
        ...
        // GET: /gl/Countries/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: /gl/Countries/Create
