...
{
    public class RegionsController : IrisController
    {
        ...
        // GET: /rm/Regions/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: /rm/Regions/Create
